 ...
 * @author DC45-61
 */
public class FormatoTabla3 extends DefaultTableCellRenderer{    
  ...
  @Override 
    public Component getTableCellRendererComponent ( JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column ) 
    {
       Color colorgr=new Color(204,204,255);
        ...
        if(String.valueOf(table.getValueAt(row,0)).contains("R -"))
        {
        componente.setBackground(colorred);
       }else if(String.valueOf(table.getValueAt(row,0)).contains("T -")){
